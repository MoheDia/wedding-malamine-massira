...
export async function generateFairePart(hasFull) {
  ...
  if (hasFull) {
    ...
    drawEventCard(ctx, W, 1040, '#D4AF37', danceImg, 'Célébration', '17h00 — La Bella', '16 Rue de Pontault, 77680 Roissy-en-Brie')
  } else {
    drawEventCard(ctx, W, 760,  '#D4AF37', danceImg, 'Célébration', '17h00 — La Bella', '16 Rue de Pontault, 77680 Roissy-en-Brie')
  }
